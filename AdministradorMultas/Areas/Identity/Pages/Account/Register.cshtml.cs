...
namespace AdministradorMultas.Areas.Identity.Pages.Account
{
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"\r\nNo se puede crear una instancia de '{nameof(IdentityUser)}'. " +
                    $"Asegúrese de que '{nameof(IdentityUser)}' no sea una clase abstracta y tenga un constructor sin parámetros, o alternativa " +
